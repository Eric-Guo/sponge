...
PROJECT_NAME := "github.com/Eric-Guo/sponge"
PKG := "$(PROJECT_NAME)"
...
install:
	...
	go install github.com/Eric-Guo/sponge/cmd/protoc-gen-go-gin@thruster_generate
	go install github.com/Eric-Guo/sponge/cmd/protoc-gen-go-rpc-tmpl@thruster_generate
...
graph:
	...
	go-callvis -skipbrowser -format=svg -nostd -file=serverNameExample_mixExample github.com/Eric-Guo/sponge
