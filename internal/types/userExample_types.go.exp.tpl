...
// Delete{{.TableNamePluralCamel}}By{{.ColumnNamePluralCamel}}Request request params
type Delete{{.TableNamePluralCamel}}By{{.ColumnNamePluralCamel}}Request struct {
	{{.ColumnNamePluralCamel}} []{{.GoType}} `json:"{{.ColumnNamePluralCamelFCL}}" binding:"min=1"`
}

// Get{{.TableNameCamel}}ByConditionRequest request params
type Get{{.TableNameCamel}}ByConditionRequest struct {
	query.Conditions
}

// Get{{.TableNameCamel}}ByConditionReply only for api docs
type Get{{.TableNameCamel}}ByConditionReply struct {
	Code int    `json:"code"` // return code
	Msg  string `json:"msg"`  // return information description
	Data struct {
		{{.TableNameCamel}} {{.TableNameCamel}}ObjDetail `json:"{{.TableNameCamelFCL}}"`
...
// List{{.TableNamePluralCamel}}By{{.ColumnNamePluralCamel}}Request request params
type List{{.TableNamePluralCamel}}By{{.ColumnNamePluralCamel}}Request struct {
	{{.ColumnNamePluralCamel}} []{{.GoType}} `json:"{{.ColumnNamePluralCamelFCL}}" binding:"min=1"`
}

// List{{.TableNamePluralCamel}}By{{.ColumnNamePluralCamel}}Reply only for api docs
type List{{.TableNamePluralCamel}}By{{.ColumnNamePluralCamel}}Reply struct {
	Code int    `json:"code"` // return code
	Msg  string `json:"msg"`  // return information description
	Data struct {
		{{.TableNamePluralCamel}} []{{.TableNameCamel}}ObjDetail `json:"{{.TableNamePluralCamelFCL}}"`
