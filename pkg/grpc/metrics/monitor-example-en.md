...
Here is the [script for starting the Prometheus service](https://github.com/Eric-Guo/sponge/tree/thruster_generate/test/server/monitor/prometheus). Start the Prometheus service:
...
Here is the [script for starting the Grafana service](https://github.com/Eric-Guo/sponge/tree/thruster_generate/test/server/monitor/grafana). Start the Grafana service:
...
Import the [HTTP monitoring dashboard](https://github.com/Eric-Guo/sponge/blob/thruster_generate/pkg/gin/middleware/metrics/gin_grafana.json) into Grafana. If the monitoring interface does not display data, check if the data source name in the JSON matches the Prometheus data source name in Grafana's configuration.
...
Import the [grpc service monitoring dashboard](https://github.com/Eric-Guo/sponge/blob/thruster_generate/pkg/grpc/metrics/server_grafana.json) into Grafana. If the monitoring interface does not display data, check if the data source name in the JSON matches the Prometheus data source name in Grafana's configuration.
...
The monitoring for the grpc client is similar to the server monitoring, and you can find the [grpc client monitoring dashboard](https://github.com/Eric-Guo/sponge/blob/thruster_generate/pkg/grpc/metrics/client_grafana.json) here.
...
Start a local Consul service using the [Consul service start script](https://github.com/Eric-Guo/sponge/tree/thruster_generate/test/server/consul):
